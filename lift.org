...
** Pullups +2.5
+ separate wrists outward while pulling to avoid rotator cuff being a primary driver
  + train lat stability using dip (pull lats elbow pulled to side of ribs to go up) from floor exerciae
...
** Bench press 7.5
+ biceps tight stabilize elbow
+ turn wrist inward as pushing (esp right) for elbow stable
  + also means turn elbow outward and locking shoulder
...
+ lock wrist inward, along front and up axis?
+ try lifting ina V?
